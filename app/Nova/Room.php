...
class Room extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            MediaField::make('Галерея', 'images')->multiple()->required(),
            MediaField::make('Планшетна Галерея', 'tablet_images')->multiple()->required(),
            MediaField::make('Мобільна Галерея', 'mobile_images')->multiple()->required(),
