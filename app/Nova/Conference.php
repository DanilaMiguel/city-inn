...
class Conference extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            MediaField::make('Галерея', 'images')->multiple(),
            MediaField::make('Планшетна Галерея', 'tablet_images')->multiple(),
            MediaField::make('Мобільна Галерея', 'mobile_images')->multiple(),
            Number::make("Сортування",'sort')->default(100)->sortable(),
            Boolean::make("Активність","active"),
            Boolean::make("Конференц зали","is_conference_services"),
    ...
    {
        return __('Сторінка конференцій');
    }
}
